                ...
                <div className="catalog-grid__props catalog-props">
                  <div className="catalog-props__top">
                    ...
                    <div className="catalog-props__columns catalog-columns">
                      <span className="catalog-columns__text">
                        Column number:
                      </span>
                  ...
                  <div className="catalog-props__choice catalog-choice">
                    <button className="btn-reset catalog-choice__clear">
                      Clear all
                    </button>
                  </div>
                  {products.length !== 0 ? (
                    <>
                      <ul
                        className="catalog-grid__content"
                        data-grid-columns="4"
                      >
                        {products &&
                    ...
                    <p className="catalog-grid__no-items">
                      В данной категории нету товара
                    </p>
                  )}
                </div>
              </div>
