...
function Filters({ sortBy, gender, page }) {
  ...
  }, [page, sizeQuery, categoryQuery, priceQuery, brandQuery, sortQuery]);
    ...
    <div className="catalog-filters">
      <div
        className={`catalog-filter ${
          visbileCategory ? 'catalog-filter--open' : ''
        }`}
      >
        <div
          className="catalog-filter__top"
          onClick={() => setVisbileCategory(!visbileCategory)}
        >
      ...
      <div
        className={`catalog-filter ${
          visbileSizes ? 'catalog-filter--open' : ''
        }`}
      >
        <div
          className="catalog-filter__top"
          onClick={() => setVisbileSizes(!visbileSizes)}
        >
          <div className="catalog-filter__caption">
      ...
      <div
        className={`catalog-filter ${
          visbilePrice ? 'catalog-filter--open' : ''
        }`}
      >
        <div
          className="catalog-filter__top"
          onClick={() => setVisbilePrice(!visbilePrice)}
        >
          <div className="catalog-filter__caption">
        ...
        <div className="catalog-filter__bottom ">
          <ul className="catalog-filter__items catalog-filter__items--inputs">
            ...
            <button
              className="catalog-filter__btn btn-reset"
              onClick={onSubmitPriceChanges}
            >
              Применить
            </button>
          </ul>
